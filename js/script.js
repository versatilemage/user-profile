...
const databaseMap = getLocalData.profile.map((item) => {
    ...
    <div class="nameofusers"><strong>Name : </strong>${item.user.name.title}. ${item.user.name.first} ${item.user.name.last}</div>
    <label><strong>User-ID : </strong></label>
    <a class="user-name" href="../html/profile.html?id=${item.userid}" value="${item.userid}">${item.userid}</a> 
    <div class="user-name"><strong>Team : </strong>${(item.team)}</div>
    <div class="user-designation"><strong>Designation : </strong>${(item["job-title"])}</div>
    <div class="contact-info"><strong>Contact Number : </strong> ${item.user.contact}</div>
    <div class="mailId"><strong>E-mail : </strong> ${item.user.email}</div>
    <div class="JoinDate"><strong>Join Date : </strong> ${item.user["join-date"]}</div>
    <div class="LastOnline"><strong>Last online : </strong> ${item["last-login"].datetime}</div>
    </div></div>`
})
